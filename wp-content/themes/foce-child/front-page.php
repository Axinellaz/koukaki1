...
?>
    ...
    <main id="primary" class="site-main">
        ...
        <section id="#story" class="story">
            <h2 class="title-h2"><span class="fadeinBottomStory" >L'histoire</span>
            </h2>
            <article id="" class="story__article">
                <p class="zindex-p-story"><?php echo get_theme_mod('story'); ?></p>
            </article>
            <?php
            $args = array(
            ...
            <article id="characters">
                <div class="main-character">
                    <h3 class="title-h3">
                        <span class="fadeinBottomCharacters">Les personnages</span>
                    </h3>
            ...
            <article id="place">
                <div class="container">
                    <h3 class="title-h3-place">
                        <span class="fadeinBottomPlace">Le Lieu</span>
                    </h3>
